...
export default function Video_Subtitles_Section({ index, id, language, date, setIsEditingCreatingSubtitleCues, openModal }) {
    ...
    <>
      ...
      <div className="all-subtitles-table-section">
        ...
        <div className="all-subtitles-table-body all-subtitles-table-section-btns">
          ...
          >
            {videoSubtitles && videoSubtitles[index].subtitlesCues.length ? 'Editar legendas' : 'Inserir legendas'}
          </button>
          <button
            className="primary-button"
            type="button"
