...
import { setTitle, setOriginalContentCategory, setOriginalContentLanguage, setDescription, removeAllSections } from '@/slicers/TempAudioContentSlice';
...
export default function Audio_Forms_Step1({ handleNextStep, original_content_file, setOriginal_content_file, original_content_PreviewUrl, setOriginal_content_PreviewUrl }) {
  ...
  const original_content_category = useSelector((state) => state.TempAudioContentSlice.original_content_category || '');
  const original_content_language = useSelector((state) => state.TempAudioContentSlice.original_content_language || '');
  const description = useSelector((state) => state.TempAudioContentSlice.description);
      ...
      <div className="forms-step1-container">
        ...
        {original_content_file ? (
          <div
            ...
            aria-live="assertive"
          >
            <label>Conteúdo original (Carrega um ficheiro de áudio)</label>
            <div
          ...
          >
            <label htmlFor="fileImport">Conteúdo original (Carrega um ficheiro de áudio)</label>
            <div
              {...getRootProps({
                className: 'dropzone',
                tabIndex: 0,
